...
exports.FaqList = exports.initNewFaqCategory = void 0;
const service_1 = __importDefault(require("./service"));
function initNewFaqCategory() {
    return __awaiter(this, void 0, void 0, function* () {
        const faqs = exports.FaqList.sections.map((item, index) => __awaiter(this, void 0, void 0, function* () {
            const newCategory = yield service_1.default.createNew({ id: item.id, name: item.name,
...
exports.initNewFaqCategory = initNewFaqCategory;
exports.FaqList = {
    "sections": [
        {
            "id": 1,
